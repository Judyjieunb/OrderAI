...
- `src/App.jsx` - Main app with sidebar navigation (3 tabs)
- `src/components/SeasonClosing.jsx` - Season closing dashboard (KPI, balance grouped bar, BCG scatter, grade distribution)
- `src/components/BudgetControl.jsx` - AI budget control panel (Claude API proposal + manual adjustment + confirm)
